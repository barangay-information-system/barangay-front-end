...
@Component({
    selector: 'app-business-issuance-list',
    templateUrl: './business-issuance-list.component.html',
    styleUrl: './business-issuance-list.component.scss',
})
export class BusinessIssuanceListComponent implements OnInit {
    ...
    loadStatus() {
        ...
        this.statusService.data_status.subscribe((result) => {
            this.statuses = result.filter(item => item.application_type === 'For Issuance');
